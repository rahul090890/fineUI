materialAdmin
		...
		.service(
				...
				[
						'$resource',
						function($resource) {
							this.getRecentitem = function(id, name, from_date,
									to_date, total_days, status, department) {
		...
		.service(
				...
				[
						...
						function($resource) {
							this.getRecentitem = function(id, name, from_date,
									to_date, total_hour, status, department,
									reporting_manager) {
		...
		.service(
				...
				function() {
					var ss = {};
					ss.malihuScroll = function scrollBar(selector, theme,
							mousewheelaxis) {
